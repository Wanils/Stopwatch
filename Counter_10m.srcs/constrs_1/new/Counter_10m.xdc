...
#set_property PACKAGE_PIN W19 [get_ports changedown]						
#	set_property IOSTANDARD LVCMOS33 [get_ports changedown]
#set_property PACKAGE_PIN T17 [get_ports changeup]						
#	set_property IOSTANDARD LVCMOS33 [get_ports changeup]
